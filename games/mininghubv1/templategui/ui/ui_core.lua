...
-- [S13] UI COMPONENT BUILDER
--------------------------------------------------------------------------------
-- Runtime lama dibersihkan oleh bridge.lua sebelum namespace baru dibuat.
-- Jangan membersihkan Maid di sini karena notify.lua sudah mendaftarkan
-- container notifikasi pada runtime yang sedang aktif.
