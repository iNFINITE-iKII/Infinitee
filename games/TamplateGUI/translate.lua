...
local LANG_STRINGS = {
    Indonesia = {
        ...
        lblSellByRarityInterval="Interval Auto Sell (0 = tanpa jeda)",
        ...
        titleLoad="✦ XIFIL HUB",
        -- Tab Forge
        secForgeCtrl="Kontrol Utama",
        secForgeRecipe="Resep & Tempa",
        secForgeOre="Komposisi Ore",
        secForgeTarget="Target Mode",
        lblPerfectForge="⭐ Perfect Forge (Auto Max Rating)",
        lblAutoForge="⚒️ Aktifkan Auto Forge",
        lblTargetMode="🎯 Target Mode (Simpan yang cocok)",
        lblAutoDelete="🗑️ Auto Hapus Non-Match",
        btnAddProfile="➕ Tambah Target Profil",
        btnForgeRecipe="📋 Pilih Resep",
        -- Tab NPC
        secIsland1="🏝️ Sec Island 1",
        secIsland2="🏝️ Sec Island 2",
        btnForgeIsland1="🔨 Forge (Island 1)",
        btnGuideIsland1="🧭 The Guide",
        btnEnchantIsland1="🔮 Enchantment",
        btnMerchantIsland1="💎 Merchant",
        btnGroceryIsland1="🛒 Grocery",
        btnPetUpgradeIsland1="🐾 Pets Upgrade",
        btnPetExpIsland1="🏕️ Pet Expedition",
        btnBlessIsland1="✨ Bless Equipments",
        btnSpinWheelIsland1="🎰 Spin Wheel",
        btnFastPassIsland1="🎫 Fast Pass",
        btnForgeNpcIsland1="🗡️ NPC Tempa (Talk)",
        btnCaveTalkIsland1="🗿 Cave Talk",
        btnTipsFistIsland1="👊 Tips Fist",
        btnTipsBowIsland1="🏹 Tips Bow",
        btnTipsScrollIsland1="📜 Tips Scroll",
        btnForgeIsland2="🔨 Forge (Island 2)",
        btnGuideIsland2="🧭 The Guide",
        btnEnchantIsland2="🔮 Enchantment",
        btnMerchantIsland2="💎 Merchant",
        btnGroceryIsland2="🛒 Grocery",
        btnPetUpgradeIsland2="🐾 Pets Upgrade",
        btnPetExpIsland2="🏕️ Pet Expedition",
        btnBlessIsland2="✨ Bless Equipments",
        btnSpinWheelIsland2="🎰 Spin Wheel",
        btnForgeNpcIsland2="🗡️ NPC Tempa (Talk)",
    },
    English = {
      ...
      tabRoom="🗺️ Room",         tabForge="⚒️ Auto Forge", tabNpc="🏪 NPC",
        ...
        lblSellByRarityInterval="Auto Sell Interval (0 = no delay)",
        ...
        titleLoad="✦ XIFIL HUB",
        -- Tab Forge
        secForgeCtrl="Main Control",
        secForgeRecipe="Recipe & Craft",
        secForgeOre="Ore Composition",
        secForgeTarget="Target Mode",
        lblPerfectForge="⭐ Perfect Forge (Auto Max Rating)",
        lblAutoForge="⚒️ Enable Auto Forge",
        lblTargetMode="🎯 Target Mode (Keep matching items)",
        lblAutoDelete="🗑️ Auto Delete Non-Match",
        btnAddProfile="➕ Add Target Profile",
        btnForgeRecipe="📋 Select Recipe",
        -- Tab NPC
        secIsland1="🏝️ Sec Island 1",
        secIsland2="🏝️ Sec Island 2",
        btnForgeIsland1="🔨 Forge (Island 1)",
        ...
        btnSpinWheelIsland1="🎰 Spin Wheel",
        btnFastPassIsland1="🎫 Fast Pass",
        btnForgeNpcIsland1="🗡️ Forge NPC (Talk)",
        btnCaveTalkIsland1="🗿 Cave Talk",
        btnTipsFistIsland1="👊 Tips Fist",
        btnTipsBowIsland1="🏹 Tips Bow",
        btnTipsScrollIsland1="📜 Tips Scroll",
        ...
        btnBlessIsland2="✨ Bless Equipments",
        btnSpinWheelIsland2="🎰 Spin Wheel",
        btnForgeNpcIsland2="🗡️ Forge NPC (Talk)",
    },
}
