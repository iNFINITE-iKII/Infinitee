--------------------------------------------------------------------------------
--// XiFil DRM Wrapper — Clover Origins
...
startWithDRM(function(key, hwid)
    ...
    local function load(url)
        ...
        if not ok then warn("[XiFil-CO] Gagal load: " .. url .. "\n" .. tostring(err)) end
    end
